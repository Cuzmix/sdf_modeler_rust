...
function(apply_cargokit target manifest_dir lib_name any_symbol_name)
    ...
    # Resolve manifest_dir through symlinks (Flutter plugin symlinks break relative paths).
    # cargokit_cmake_root is already symlink-resolved at the top of this file.
    # Since cargokit/ and windows/ are siblings under the same parent, manifest_dir
    # (relative to windows/) works identically when applied to cargokit/.
    get_filename_component(_manifest_dir_resolved "${cargokit_cmake_root}/${manifest_dir}" ABSOLUTE)

    set(CARGOKIT_ENV
        "CARGOKIT_CMAKE=${CMAKE_COMMAND}"
        "CARGOKIT_CONFIGURATION=$<CONFIG>"
        "CARGOKIT_MANIFEST_DIR=${_manifest_dir_resolved}"
