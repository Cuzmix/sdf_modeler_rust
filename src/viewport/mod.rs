...
pub use gpu_ops::{ViewportPostProcessOptions, ViewportRenderRequest};

use std::num::NonZeroU64;

use bytemuck::{Pod, Zeroable};
use reference_overlay::ReferenceOverlayRenderer;
...
pub struct ViewportResources {
    ...
    // --- Screen-space reference image overlays ---
    pub reference_overlay: ReferenceOverlayRenderer,
...
impl ViewportResources {
    ...
    pub fn new(
        ...
        let reference_overlay = ReferenceOverlayRenderer::new(device, target_format);
