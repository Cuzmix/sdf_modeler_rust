...
pub enum SerializableKey {
    ...
    Space, Enter, Escape, Tab, Delete, Home, End,
    ArrowUp, ArrowDown, ArrowLeft, ArrowRight,
    OpenBracket, CloseBracket, Slash,
}
...
impl SerializableKey {
    ...
    pub fn to_egui(self) -> egui::Key {
        match self {
            ...
            Self::Space => egui::Key::Space, Self::Enter => egui::Key::Enter,
            Self::Escape => egui::Key::Escape, Self::Tab => egui::Key::Tab,
            Self::Delete => egui::Key::Delete, Self::Home => egui::Key::Home,
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            Self::Space => "Space", Self::Enter => "Enter", Self::Escape => "Esc",
            Self::Tab => "Tab", Self::Delete => "Del", Self::Home => "Home",
            Self::End => "End",
...
impl ActionBinding {
    ...
    pub const ALL: &'static [Self] = &[
        Self::ToggleHelp, Self::ToggleDebug, Self::NewScene,
        Self::OpenProject, Self::SaveProject, Self::Undo, Self::Redo,
        Self::Copy, Self::Paste, Self::Duplicate, Self::DeleteSelected,
        Self::CopyProperties, Self::PasteProperties,
        Self::TakeScreenshot, Self::ShowExportDialog, Self::ToggleCommandPalette,
        Self::CameraFront, Self::CameraTop, Self::CameraRight,
        Self::CameraBack, Self::CameraLeft, Self::CameraBottom,
        Self::ToggleOrtho, Self::FocusSelected, Self::FrameAll,
        Self::GizmoTranslate, Self::GizmoRotate, Self::GizmoScale,
        ...
        Self::ShowQuickToolbar, Self::ToggleReferenceImages, Self::ToggleMeasurementTool,
        ...
        Self::SculptSymmetryX, Self::SculptSymmetryY, Self::SculptSymmetryZ,
        Self::ExitSculptMode,
    ];
    ...
    pub fn category(self) -> &'static str {
        match self {
            ...
            Self::Copy | Self::Paste | Self::Duplicate | Self::DeleteSelected |
            Self::CopyProperties | Self::PasteProperties |
            Self::TakeScreenshot | Self::ShowExportDialog |
            Self::ToggleCommandPalette => "General",

            Self::CameraFront | Self::CameraTop | Self::CameraRight |
            Self::CameraBack | Self::CameraLeft | Self::CameraBottom |
            Self::ToggleOrtho | Self::FocusSelected | Self::FrameAll => "Camera",

            Self::GizmoTranslate | Self::GizmoRotate | Self::GizmoScale |
            Self::ToggleGizmoSpace | Self::ResetPivot |
            ...
            Self::ToggleReferenceImages | Self::ToggleMeasurementTool => "Viewport",
...
impl Default for KeymapConfig {
    fn default() -> Self {
        ...
        bind(ActionBinding::SculptBrushShrink,  KeyCombo::new(K::OpenBracket));
        bind(ActionBinding::SculptBrushGrow,    KeyCombo::new(K::CloseBracket));
...
mod tests {
    ...
    fn set_binding_updates_keymap() {
        ...
        assert_eq!(keymap.get_binding(ActionBinding::SaveProject), Some(&new_combo));
    }
    ...
    fn reset_restores_defaults() {
        ...
        keymap.set_binding(ActionBinding::SaveProject, KeyCombo::new(SerializableKey::F12));
        assert_ne!(keymap.get_binding(ActionBinding::SaveProject), original.as_ref());

        keymap.reset_to_defaults();
        assert_eq!(keymap.get_binding(ActionBinding::SaveProject), original.as_ref());
    }

    #[test]
    fn format_shortcut_produces_readable_strings() {
        let keymap = KeymapConfig::default();
        assert_eq!(keymap.format_shortcut(ActionBinding::SaveProject), Some("Ctrl+S".to_string()));
        assert_eq!(keymap.format_shortcut(ActionBinding::CopyProperties), Some("Ctrl+Shift+C".to_string()));
        ...
        assert_eq!(keymap.format_shortcut(ActionBinding::ToggleMeasurementTool), Some("M".to_string()));
    }
    ...
    fn key_combo_display_format() {
        ...
        assert_eq!(KeyCombo::ctrl_shift(SerializableKey::C).to_string(), "Ctrl+Shift+C");
