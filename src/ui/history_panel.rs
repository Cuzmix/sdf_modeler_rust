...
pub fn draw(
    ...
    ui.horizontal(|ui| {
        if ui.add_enabled(history.undo_count() > 0, egui::Button::new("Undo")).clicked() {
            actions.push(Action::Undo);
        }
        if ui.add_enabled(history.redo_count() > 0, egui::Button::new("Redo")).clicked() {
    ...
    egui::ScrollArea::vertical().auto_shrink([false; 2]).show(ui, |ui| {
        ...
        ui.colored_label(egui::Color32::from_rgb(100, 200, 100), "\u{25B6} Current State");
