use crate::app::frontend_models::{
    InspectorBoolFieldModel, InspectorScalarFieldModel, ShellSnapshot,
};
use crate::app::slint_frontend::{
    InspectorPanelState, LightSectionState, MaterialSectionState, OperationSectionState,
    PropertyBoolFieldView, PropertyScalarFieldView, SculptSectionState, TransformSectionState,
};
...
pub(super) fn build_inspector_panel_state(snapshot: &ShellSnapshot) -> InspectorPanelState {
    InspectorPanelState {
        ...
        multi_selection_summary: snapshot
            ...
            .unwrap_or_default()
            .into(),
        transform: snapshot.inspector.transform.as_ref().map_or_else(
            blank_transform_section,
            |section| TransformSectionState {
                visible: true,
        ...
        material: snapshot.inspector.material.as_ref().map_or_else(
            blank_material_section,
            |section| MaterialSectionState {
                visible: true,
        ...
        operation: snapshot.inspector.operation.as_ref().map_or_else(
            blank_operation_section,
            |section| OperationSectionState {
                visible: true,
        ...
        sculpt: snapshot
            ...
            .sculpt
            .as_ref()
            .map_or_else(blank_sculpt_section, |section| SculptSectionState {
                visible: true,
        ...
        light: snapshot
            ...
            .light
            .as_ref()
            .map_or_else(blank_light_section, |section| LightSectionState {
                visible: true,
