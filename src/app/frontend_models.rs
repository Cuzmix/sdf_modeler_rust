...
use crate::settings::{
    ...
    GroupRotateDirection, LocalReflectionMode, MultiAxisOrientation, MultiPivotMode, Settings,
    ShadingMode,
};
...
pub struct RenderSettingsModel {
    pub show_grid: InspectorBoolFieldModel,
    pub show_node_labels: InspectorBoolFieldModel,
    pub show_bounding_box: InspectorBoolFieldModel,
    pub show_light_gizmos: InspectorBoolFieldModel,
    pub shading_mode: ShadingMode,
    pub cross_section_axis: InspectorScalarFieldModel,
    pub cross_section_position: InspectorScalarFieldModel,
    pub sculpt_safety_border: InspectorScalarFieldModel,
    pub shadows_enabled: InspectorBoolFieldModel,
    pub shadow_steps: InspectorScalarFieldModel,
    pub shadow_penumbra_k: InspectorScalarFieldModel,
    pub shadow_bias: InspectorScalarFieldModel,
    pub shadow_mint: InspectorScalarFieldModel,
    pub shadow_maxt: InspectorScalarFieldModel,
    pub ao_enabled: InspectorBoolFieldModel,
    pub ao_samples: InspectorScalarFieldModel,
    pub ao_step: InspectorScalarFieldModel,
    pub ao_decay: InspectorScalarFieldModel,
    pub ao_intensity: InspectorScalarFieldModel,
    pub ao_mode: AmbientOcclusionMode,
    pub march_max_steps: InspectorScalarFieldModel,
    pub march_epsilon: InspectorScalarFieldModel,
    pub march_step_multiplier: InspectorScalarFieldModel,
    pub march_max_distance: InspectorScalarFieldModel,
    pub key_light_dir: [InspectorScalarFieldModel; 3],
    pub key_diffuse: InspectorScalarFieldModel,
    pub key_spec_power: InspectorScalarFieldModel,
    pub key_spec_intensity: InspectorScalarFieldModel,
    pub key_light_color: [InspectorScalarFieldModel; 3],
    pub fill_light_dir: [InspectorScalarFieldModel; 3],
    pub fill_intensity: InspectorScalarFieldModel,
    pub fill_light_color: [InspectorScalarFieldModel; 3],
    pub ambient: InspectorScalarFieldModel,
    pub env_reflection_enabled: InspectorBoolFieldModel,
    pub env_reflection_intensity: InspectorScalarFieldModel,
    pub specular_aa_enabled: InspectorBoolFieldModel,
    pub local_reflection_mode: LocalReflectionMode,
    pub environment_source: EnvironmentSource,
    pub hdri_path_display: String,
    pub environment_rotation_degrees: InspectorScalarFieldModel,
    pub environment_exposure: InspectorScalarFieldModel,
    pub environment_bake_resolution: InspectorScalarFieldModel,
    pub environment_background_mode: EnvironmentBackgroundMode,
    pub environment_background_blur: InspectorScalarFieldModel,
    pub sky_horizon: [InspectorScalarFieldModel; 3],
    pub sky_zenith: [InspectorScalarFieldModel; 3],
    pub background_mode: BackgroundMode,
    pub bg_solid_color: [InspectorScalarFieldModel; 3],
    pub sss_enabled: InspectorBoolFieldModel,
    pub sss_strength: InspectorScalarFieldModel,
    pub sss_color: [InspectorScalarFieldModel; 3],
    pub volumetric_steps: InspectorScalarFieldModel,
    pub fog_enabled: InspectorBoolFieldModel,
    pub fog_density: InspectorScalarFieldModel,
    pub fog_color: [InspectorScalarFieldModel; 3],
    pub bloom_enabled: InspectorBoolFieldModel,
    pub bloom_threshold: InspectorScalarFieldModel,
    pub bloom_intensity: InspectorScalarFieldModel,
    pub bloom_radius: InspectorScalarFieldModel,
    pub gamma: InspectorScalarFieldModel,
    pub tonemapping_aces: InspectorBoolFieldModel,
    pub outline_color: [InspectorScalarFieldModel; 3],
    pub outline_thickness: InspectorScalarFieldModel,
    pub sculpt_fast_mode: InspectorBoolFieldModel,
    pub auto_reduce_steps: InspectorBoolFieldModel,
    pub interaction_render_scale: InspectorScalarFieldModel,
    pub rest_render_scale: InspectorScalarFieldModel,
    pub composite_volume_enabled: InspectorBoolFieldModel,
    pub composite_volume_resolution: InspectorScalarFieldModel,
    pub debug_force_manual_sculpt_sampling: InspectorBoolFieldModel,
    pub export_resolution: InspectorScalarFieldModel,
    pub adaptive_export: InspectorBoolFieldModel,
}
...
pub fn build_utility_model(
    ...
    UtilityModel {
        ...
        render_settings: RenderSettingsModel {
            show_grid: bool_field(settings.render.show_grid),
            show_node_labels: bool_field(settings.render.show_node_labels),
            show_bounding_box: bool_field(settings.render.show_bounding_box),
            show_light_gizmos: bool_field(settings.render.show_light_gizmos),
            shading_mode: settings.render.shading_mode,
            cross_section_axis: int_field(
                settings.render.cross_section_axis as f32,
                0.0,
                2.0,
                1.0,
            ),
            cross_section_position: float_field(
                settings.render.cross_section_position,
                -4.0,
                4.0,
                0.01,
                2,
            ),
            sculpt_safety_border: float_field(
                settings.render.sculpt_safety_border,
                0.0,
                0.25,
                0.005,
                3,
            ),
            shadows_enabled: bool_field(settings.render.shadows_enabled),
            shadow_steps: int_field(settings.render.shadow_steps as f32, 1.0, 256.0, 1.0),
            shadow_penumbra_k: float_field(settings.render.shadow_penumbra_k, 0.0, 64.0, 0.1, 2),
            shadow_bias: float_field(settings.render.shadow_bias, 0.0, 0.1, 0.0005, 4),
            shadow_mint: float_field(settings.render.shadow_mint, 0.0, 2.0, 0.01, 2),
            shadow_maxt: float_field(settings.render.shadow_maxt, 0.1, 512.0, 1.0, 1),
            ao_enabled: bool_field(settings.render.ao_enabled),
            ao_samples: int_field(settings.render.ao_samples as f32, 1.0, 128.0, 1.0),
            ao_step: float_field(settings.render.ao_step, 0.001, 2.0, 0.001, 3),
            ao_decay: float_field(settings.render.ao_decay, 0.0, 2.0, 0.01, 2),
            ao_intensity: float_field(settings.render.ao_intensity, 0.0, 4.0, 0.01, 2),
            ao_mode: settings.render.ao_mode,
            march_max_steps: int_field(settings.render.march_max_steps as f32, 8.0, 1024.0, 1.0),
            march_epsilon: float_field(settings.render.march_epsilon, 0.0001, 0.1, 0.0001, 4),
            march_step_multiplier: float_field(
                settings.render.march_step_multiplier,
                0.1,
                4.0,
                0.01,
                2,
            ),
            march_max_distance: float_field(
                settings.render.march_max_distance,
                1.0,
                4096.0,
                1.0,
                1,
            ...
            key_light_dir: [
                float_field(settings.render.key_light_dir[0], -1.0, 1.0, 0.01, 2),
                float_field(settings.render.key_light_dir[1], -1.0, 1.0, 0.01, 2),
                float_field(settings.render.key_light_dir[2], -1.0, 1.0, 0.01, 2),
            ],
            key_diffuse: float_field(settings.render.key_diffuse, 0.0, 8.0, 0.01, 2),
            key_spec_power: float_field(settings.render.key_spec_power, 1.0, 256.0, 1.0, 0),
            key_spec_intensity: float_field(
                settings.render.key_spec_intensity,
                0.0,
                8.0,
                0.01,
                2,
            ...
            key_light_color: [
                float_field(settings.render.key_light_color[0], 0.0, 4.0, 0.01, 2),
                float_field(settings.render.key_light_color[1], 0.0, 4.0, 0.01, 2),
                float_field(settings.render.key_light_color[2], 0.0, 4.0, 0.01, 2),
            ],
            fill_light_dir: [
                float_field(settings.render.fill_light_dir[0], -1.0, 1.0, 0.01, 2),
                float_field(settings.render.fill_light_dir[1], -1.0, 1.0, 0.01, 2),
                float_field(settings.render.fill_light_dir[2], -1.0, 1.0, 0.01, 2),
            ],
            fill_intensity: float_field(settings.render.fill_intensity, 0.0, 8.0, 0.01, 2),
            fill_light_color: [
                float_field(settings.render.fill_light_color[0], 0.0, 4.0, 0.01, 2),
                float_field(settings.render.fill_light_color[1], 0.0, 4.0, 0.01, 2),
                float_field(settings.render.fill_light_color[2], 0.0, 4.0, 0.01, 2),
            ],
            ambient: float_field(settings.render.ambient, 0.0, 4.0, 0.01, 2),
            env_reflection_enabled: bool_field(settings.render.env_reflection_enabled),
            env_reflection_intensity: float_field(
                settings.render.env_reflection_intensity,
                0.0,
                4.0,
                0.01,
                2,
            ),
            specular_aa_enabled: bool_field(settings.render.specular_aa_enabled),
            local_reflection_mode: settings.render.local_reflection_mode,
            environment_source: settings.render.environment_source,
            hdri_path_display: settings
                .render
                .hdri_path
                .clone()
                .unwrap_or_else(|| "No HDRI selected".to_string()),
            environment_rotation_degrees: float_field(
                settings.render.environment_rotation_degrees,
                -180.0,
                180.0,
                1.0,
                0,
            ),
            environment_exposure: float_field(
                settings.render.environment_exposure,
                -8.0,
                8.0,
                0.05,
                2,
            ),
            environment_bake_resolution: int_field(
                settings.render.environment_bake_resolution as f32,
                0.0,
                4096.0,
                16.0,
            ),
            environment_background_mode: settings.render.environment_background_mode,
            environment_background_blur: float_field(
                settings.render.environment_background_blur,
                0.0,
                1.0,
                0.01,
                2,
            ...
            sky_horizon: [
                float_field(settings.render.sky_horizon[0], 0.0, 1.0, 0.01, 2),
                float_field(settings.render.sky_horizon[1], 0.0, 1.0, 0.01, 2),
                float_field(settings.render.sky_horizon[2], 0.0, 1.0, 0.01, 2),
            ],
            sky_zenith: [
                float_field(settings.render.sky_zenith[0], 0.0, 1.0, 0.01, 2),
                float_field(settings.render.sky_zenith[1], 0.0, 1.0, 0.01, 2),
                float_field(settings.render.sky_zenith[2], 0.0, 1.0, 0.01, 2),
            ],
            background_mode: settings.render.background_mode,
            bg_solid_color: [
                float_field(settings.render.bg_solid_color[0], 0.0, 1.0, 0.01, 2),
                float_field(settings.render.bg_solid_color[1], 0.0, 1.0, 0.01, 2),
                float_field(settings.render.bg_solid_color[2], 0.0, 1.0, 0.01, 2),
            ],
            sss_enabled: bool_field(settings.render.sss_enabled),
            sss_strength: float_field(settings.render.sss_strength, 0.0, 2.0, 0.01, 2),
            sss_color: [
                float_field(settings.render.sss_color[0], 0.0, 1.0, 0.01, 2),
                float_field(settings.render.sss_color[1], 0.0, 1.0, 0.01, 2),
                float_field(settings.render.sss_color[2], 0.0, 1.0, 0.01, 2),
            ],
            volumetric_steps: int_field(settings.render.volumetric_steps as f32, 1.0, 256.0, 1.0),
            fog_enabled: bool_field(settings.render.fog_enabled),
            fog_density: float_field(settings.render.fog_density, 0.0, 2.0, 0.001, 3),
            fog_color: [
                float_field(settings.render.fog_color[0], 0.0, 1.0, 0.01, 2),
                float_field(settings.render.fog_color[1], 0.0, 1.0, 0.01, 2),
                float_field(settings.render.fog_color[2], 0.0, 1.0, 0.01, 2),
            ],
            bloom_enabled: bool_field(settings.render.bloom_enabled),
            bloom_threshold: float_field(settings.render.bloom_threshold, 0.0, 8.0, 0.01, 2),
            bloom_intensity: float_field(settings.render.bloom_intensity, 0.0, 8.0, 0.01, 2),
            bloom_radius: float_field(settings.render.bloom_radius, 0.0, 4.0, 0.01, 2),
            gamma: float_field(settings.render.gamma, 0.5, 4.0, 0.01, 2),
            tonemapping_aces: bool_field(settings.render.tonemapping_aces),
            outline_color: [
                float_field(settings.render.outline_color[0], 0.0, 1.0, 0.01, 2),
                float_field(settings.render.outline_color[1], 0.0, 1.0, 0.01, 2),
                float_field(settings.render.outline_color[2], 0.0, 1.0, 0.01, 2),
            ],
            outline_thickness: float_field(settings.render.outline_thickness, 0.0, 16.0, 0.1, 1),
            sculpt_fast_mode: bool_field(settings.render.sculpt_fast_mode),
            auto_reduce_steps: bool_field(settings.render.auto_reduce_steps),
            interaction_render_scale: float_field(
                settings.render.interaction_render_scale,
                0.25,
                1.0,
                0.01,
                2,
            ),
            rest_render_scale: float_field(
                settings.render.rest_render_scale,
                0.25,
                1.0,
                0.01,
                2,
            ),
            composite_volume_enabled: bool_field(settings.render.composite_volume_enabled),
            composite_volume_resolution: int_field(
                settings.render.composite_volume_resolution as f32,
                64.0,
                256.0,
                1.0,
            ),
            debug_force_manual_sculpt_sampling: bool_field(
                settings.render.debug_force_manual_sculpt_sampling,
            ),
            export_resolution: int_field(
                settings.export_resolution as f32,
                16.0,
                settings.max_export_resolution.max(16) as f32,
                16.0,
            ),
            adaptive_export: bool_field(settings.adaptive_export),
        },
    }
}
...
mod tests {
    ...
    fn utility_maps_environment_settings() {
        ...
        assert_eq!(model.render_settings.environment_source, EnvironmentSource::Hdri);
        assert_eq!(model.render_settings.hdri_path_display, "studio.hdr");
        assert_eq!(
            model.render_settings.environment_background_mode,
